...
export const EducationIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 13.4-4.5 4.5"/><path d="m12 13.4 4.5 4.5"/><path d="M12 3v10.4"/><path d="m10.5 12.5-8-8C1.6 3.6.8 4.8.8 6.3c0 1.6.8 2.8 1.7 3.7l8 8"/><path d="m21.5 12.5 1.7-1.7c.9-.9 1.7-2.1 1.7-3.7 0-1.5-.8-2.8-1.7-3.7l-8 8"/></svg>
);
export const MedicalIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 12v-2h-2v2H8v2h2v2h2v-2h2v-2h-2z"/></svg>
);
export const EconomicIcon: React.FC<IconProps> = (props) => (
...
export const PaperclipIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12.5 2.5a6.5 6.5 0 0 1 0 13l-9.3-9.4a4.5 4.5 0 0 1 6.4-6.3l9.3 9.3a2.5 2.5 0 0 1-3.5 3.5l-9.3-9.3"/></svg>
);
...
export const AIBrainIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a2.83 2.83 0 0 0-2 5 4.79 4.79 0 0 0-1 4.5c0 1.7 1.3 3 3 3h2c1.7 0 3-1.3 3-3a4.79 4.79 0 0 0-1-4.5 2.83 2.83 0 0 0-2-5z"/><path d="M12 14.5c-2.3 0-4.2-2-4.2-4.5 0-2.2 1.4-4 3.2-4.5"/><path d="M12 22a4.5 4.5 0 0 0 4.5-4.5c0-2.2-1.4-4-3.2-4.5"/><path d="M12 22a4.5 4.5 0 0 1-4.5-4.5c0-2.2 1.4-4 3.2-4.5"/><path d="M12 22v-7.5"/><path d="M7.5 17.5h9"/><path d="M9.5 14.5A2.5 2.5 0 0 1 7 12a2.5 2.5 0 0 1 2.5-2.5"/><path d="M14.5 14.5a2.5 2.5 0 0 0 2.5-2.5 2.5 2.5 0 0 0-2.5-2.5"/></svg>
);

export const EmotionIcon: React.FC<IconProps> = (props) => (
...
export const CredibilityIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"/></svg>
);
export const ContextIcon: React.FC<IconProps> = (props) => (
...
export const ProvenanceIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>
);

export const PoliticalBiasIcon: React.FC<IconProps> = (props) => (
...
export const ManipulateIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15.2 3.8a2 2 0 0 1 2.8 2.8L5.2 21.8a2 2 0 0 1-2.8-2.8Z"/><path d="M16 16l-2.5 2.5"/><path d="M13.5 13.5L12 12"/><path d="M8 8l-2.5 2.5"/><path d="M10.5 10.5L8 13"/><path d="m18 8 2 2"/><path d="m2 16 2 2"/><path d="m20 6-2-2"/><path d="m6 2-2 2"/></svg>
);

export const GraphIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="5" r="3"/><circle cx="18" cy="12" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="12" cy="19" r="3"/><path d="M12 8v8"/><path d="m15.5 10.5 4.5 3"/><path d="m8.5 13.5-4.5-3"/></svg>
);

export const RebuttalIcon: React.FC<IconProps> = (props) => (
